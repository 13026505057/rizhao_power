        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
            ...
            <el-dialog title="新增职位" :visible.sync="dialogFormVisible">
              <el-form :model="form">
                <el-form-item label="职位名称:" label-width="120px">
                  <el-input v-model="form.job_name" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
              </el-form>
          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                label="创建者"
                prop="job_create_user_name">
              </el-table-column>
              <el-table-column
                label="创建时间"
                prop="job_create_time">
              </el-table-column>
              <el-table-column
                label="当前状态"
                >
  ...
  export default {
      ...
      methods: {
          ...
          handleEdit(data){
              ...
              self.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                ...
                type: 'warning'
                  ...
                  params.append('job_name',data.job_name);    
                  params.append('job_id',data.job_id);
                  params.append('job_status','0');
                  self.$axios({
                      method: 'post',
                      url: '/stop/updateJob',
                      data: params,
          ...
          upData(data){
                ...
                var params = new URLSearchParams();
                var token = localStorage.getItem('auth');
                params.append('job_name',self.form.job_name);    
                params.append('job_id',self.form.job_id);
                params.append('job_status',self.form.job_status);
                self.$axios({
                    method: 'post',
                    url: '/stop/updateJob',
                    data: params,
