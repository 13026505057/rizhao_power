    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
               ...
               <el-autocomplete
                ...
                <el-button type="primary" style="margin-left: 100px;" @click="addNew">新增警员</el-button>
            </div>
        ...
        <el-dialog title="修改警员资料" :visible.sync="dialogFormVisible2">
          <el-form ref="form" :model="changeform" label-width="120px" label-position="left" style="margin-left:20px;">
            ...
            <el-form-item v-if="org_type=='office'?true:false" label="分组" style="display: inline-block;">
        ...
        <!-- 新增警员弹窗 -->
        <el-dialog title="新增警员" :visible.sync="dialogFormVisible">
          <el-form ref="form" :model="form" label-width="120px" label-position="left" style="margin-left:20px;">
            <el-form-item label="用户名*" style="display: inline-block;">
              <el-input v-model="form.ad_username" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="密码*" style="display: inline-block;margin-left: 80px;">
              <el-input v-model="form.ad_password" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="真实姓名*" style="display: inline-block;">
              <el-input v-model="form.ad_user_true_name" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="性别" style="display: inline-block;margin-left: 80px;">
              <el-input v-model="form.ad_user_sex" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="身份证号" style="display: inline-block;float: left;">
              <el-input v-model="form.ad_id_card" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="学历" style="display: inline-block;margin-left: 85px;">
              <el-select v-model="form.ad_school" placeholder="请选择" style="width: 200px;">
                <el-option
                  v-for="item in schoolHistory"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item label="联系电话" style="display: inline-block;float: left;">
              <el-input v-model="form.ad_user_tel" style="width: 200px;"></el-input>
            </el-form-item>
            <el-form-item label="部门" style="display: inline-block;margin-left: 85px;">
              <el-select v-model="form.dept_id" placeholder="请选择" style="width: 200px;">
                <el-option
                  v-for="item in deptList"
                  :key="item.dept_id"
                  :label="item.dept_name"
            ...
            <el-form-item label="职位" style="display: inline-block;margin-left: 85px;">
              <el-select v-model="form.job_id" placeholder="请选择" style="width: 200px;">
                <el-option
                  v-for="item in positionList"
                  :key="item.job_id"
                  :label="item.job_name"
            ...
            <el-form-item label="现住址" style="display: inline-block;">
              <el-input v-model="form.ad_now_address" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="邮编" style="display: inline-block;margin-left: 85px;">
              <el-input v-model="form.ad_zip_code" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="身份证地址" style="display: inline-block;">
              <el-input v-model="form.ad_card_address" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item label="家庭电话" style="display: inline-block;margin-left: 85px;">
              <el-input v-model="form.ad_home_tel" style="width: 200px;float: left;"></el-input>
            </el-form-item>
            <el-form-item v-if="org_type=='office'?true:false" label="分组" style="display: inline-block;">
                <el-select v-model="form.group_id" placeholder="请选择" style="width: 200px;">
                  <el-option
                    v-for="item in fenzuList"
                    :key="item.org_id"
                    :label="item.org_name"
            ...
            <el-table
              ...
              <el-table-column type="expand">
                <template slot-scope="props">
                  <el-form label-position="left" inline class="demo-table-expand" label-width="200">
                    <el-form-item label="登陆账号" >
                      <span>{{ props.row.ad_username }}</span>
                    </el-form-item>
                    <!-- <el-form-item label="登录密码">
                      <span>{{ props.row.ad_password }}</span>
                    </el-form-item> -->
                    <el-form-item label="联系电话">
                      <span>{{ props.row.ad_user_tel }}</span>
                    </el-form-item>
                    <el-form-item label="入职时间">
                      <span>{{ props.row.ad_join_date }}</span>
                    </el-form-item>
                    <el-form-item label="现住址">
                      <span>{{ props.row.ad_now_address }}</span>
                    </el-form-item>
                    <el-form-item label="身份证地址">
                      <span>{{ props.row.ad_card_address }}</span>
                    </el-form-item>
                    <el-form-item label="邮编">
                      <span>{{ props.row.ad_zip_code }}</span>
                    </el-form-item>
                    <el-form-item label="家庭电话">
                      <span>{{ props.row.ad_home_tel }}</span>
                    </el-form-item>
                    <!-- <el-form-item label="分组">
                      <span>{{ props.row.group_name }}</span>
                    </el-form-item> -->
                    <el-form-item label="学历">
                      <span>{{ props.row.ad_school }}</span>
                    </el-form-item>
                    <div style="width:300px;height:50px;margin:0 auto;margin-top:30px;">
                      <el-button type="warning" size="mini" style="margin-left: 30px;" @click="changeData(props.row)">修改资料</el-button>
                    </div>
  ...
  export default {
      ...
      methods: {
          ...
          sureToChange(){
                ...
                params.append('group_id',this.changeform.group_id);   
                self.$axios({
                    method: 'post',
          ...
          sureToAddNew(){
                ...
                var params = new URLSearchParams();
                var token = localStorage.getItem('auth');
                if(self.form.ad_password==''||self.form.ad_password==null){
                  var passwordmd5 = '';
                }else{
                  var passwordmd5 = md5.hex(self.form.ad_password);
                }
                
                params.append('ad_password',passwordmd5);
                params.append('ad_username',self.form.ad_username); 
                params.append('ad_user_true_name',self.form.ad_user_true_name);
                params.append('ad_user_sex',self.form.ad_user_sex);    
                params.append('ad_id_card',self.form.ad_id_card); 
                params.append('ad_school',self.form.ad_school);
                params.append('ad_birthday',self.form.ad_birthday);
                params.append('dept_id',self.form.dept_id);   
                params.append('job_id',this.form.job_id);
                params.append('ad_join_date',self.form.ad_join_date); 
                params.append('ad_now_address',self.form.ad_now_address);
                params.append('ad_card_address',self.form.ad_card_address);
                params.append('ad_zip_code',self.form.ad_zip_code);   
                params.append('ad_home_tel',this.form.ad_home_tel);
                params.append('ad_user_tel',this.form.ad_user_tel);
                params.append('group_id',this.form.group_id);
          ...
          getDataList(){
                ...
                params.append('ad_id_card',self.number);   
                params.append('org_id',this.org_idList);      
                self.$axios({
                    method: 'post',
                    url: '/stop/getAdUser',
                    data: params,
