    ...
    <div>
        <div >
            <div class="block">
               ...
               <!--  <el-select v-model="laobao_type" clearable filterable placeholder="请选择类型">
                  <el-option
                ...
                <el-select 
                    ...
                    placeholder="姓名">
                      <el-option
                        style="height:40px;"
                        v-for="item,index in userNameList1"
                        :key="index"
                        :label="item.label"
                        :value="item.label">
                      </el-option>
        ...
        <div id="container" style="width: 100%;height: 110%; margin-top: 20px;">
          ...
          <el-dialog  title="修改劳保物品" :visible.sync="dialogFormVisible">
                    ...
                    <el-form ref="form" :model="changeform" label-width="120px" label-position="left" style="margin-left:20px;">
                      <el-form-item label="劳保名称" style="">
                        <el-input v-model="changeform.laobao_name" style="width: 300px;"></el-input>
                      </el-form-item>
          ...
          <el-dialog
              ...
              width="40%">
              <el-form ref="form" :model="timeform" label-width="140px" label-position="left" style="margin-left:20px;">
                <el-form-item v-if="deptHid" label="选择部门" style="">
                  <!-- <el-checkbox-group v-model="timeform.dept_id">
                    <el-checkbox-button v-for="city in bumenList" :label="city" :key="city">{{city}}</el-checkbox-button>
                  </el-checkbox-group> -->
                </el-form-item>
                <el-form-item label="初始发放时间" >
                  <el-date-picker
                    style="width: 300px;"
                    format="yyyy-MM-dd"
  ...
  export default {
      ...
      methods: {
          ...
          handleEdit(res){
                ...
                params.append('laobao_id',res.laobao_id);
                self.$axios({
                    method: 'post',
                    url: '/store/laobao/del',
                    data: params,
          ...
          updataClick(data){
            ...
            this.changeform.laobao_name = data.laobao_name;
            this.changeform.laobao_type = data.laobao_type;
          ...
          sureToChange(){
                ...
                params.append('laobao_name',self.changeform.laobao_name);
                params.append('laobao_type',self.changeform.laobao_type);
          ...
          getDataList(){
                ...
                if(self.date1==null||self.date1.length==0){
                  var begin_time = '';
                  var end_time = '';
                }else{
                  var begin_time = self.date1[0];
                  var end_time = self.date1[1];
                } 
                ...
                self.$axios({
                    method: 'post',
                    url: '/store/laobao/getUserLaoBaoLogByPage',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
                    if(data.data.code==0){
          ...
          getNameSearchList1(query){
                ...
                self.$axios({
                    ...
                    if(data.data.code==0){
                      ...
                      self.userNameList1 = self.list1;
                      // console.log(self.userNameList1)
                    }else{
                      self.$response(data,self);
                    }
                 });
