          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                ...
                <el-table-column
                  align="center"
                  v-for="(item,index) in tableData5[0].userReportList"
                  :label="item.report_name"
                  prop="item.uploaded_count"
                  >
                  <template slot-scope="props">
                    <span>{{props.row.userReportList[index].uploaded_count}}</span>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column
                ...
                <el-table-column
                  ...
                  >
                  <template slot-scope="props">
                    <span>{{props.row.userReportList[index].notUpload_count}}</span>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column
  ...
  export default {
      ...
      methods: {
          ...
          downLoad(){
                ...
                self.$axios({
                    method: 'post',
                    url: '/stop/export/allReportExport',
                    data: params,
          ...
          getDataList(){
                ...
                self.$axios({
                    method: 'post',
                    url: '/stop/export/allReportQuery',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
                    if(data.data.code==0){
