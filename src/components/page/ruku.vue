        ...
        <div id="container" style="width: 100%;height: 110%; margin-top: 20px;">
          ...
          <div class="tableList">
            <el-tabs type="border-card" @tab-click="tableClick" v-model="tabPosition">
              <el-tab-pane label="待入库" name="need">
                <el-table
                  :data="goodsDetail"
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="props">
                      ...
                      <el-button size="mini" type="warning" style="" @click.stop="approve(props.row)">确认入库</el-button>
                    </template>
                  </el-table-column>
              ...
              <el-tab-pane label="入库记录" name="history">
                <el-table
                  ...
                  <el-table-column
                    ...
                    >
                    <template slot-scope="props">
                      <span>{{props.row.userApplyHead.user_apply_status==0?'驳回':''}}{{props.row.userApplyHead.user_apply_status==1?'通过':''}}{{props.row.userApplyHead.user_apply_status==2?'审批中':''}}{{props.row.userApplyHead.user_apply_status==3?'已出库':''}}{{props.row.userApplyHead.user_apply_status==4?'已入库':''}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column
                    label="操作"
