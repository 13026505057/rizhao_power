    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-select v-model="dept_id" clearable filterable placeholder="请选择部门">
                  <el-option
                ...
                <el-button type="primary" style="margin-left: 60px;" @click="addZhouqiClick">新增</el-button>
            ...
            >
                  <el-form ref="form" :model="form" label-width="150px" label-position="left" style="margin-left:20px;">
                      ...
                      <el-form-item label="部门" >
                        <el-select v-model="form.dept_id" clearable style="width: 400px;" placeholder="请选择">
                            <el-option
                              v-for="item in bumenList"
                              :key="item.dept_id"
                              :label="item.dept_name"
          ...
          <el-dialog  title="修改周期" :visible.sync="dialogFormVisible">
              ...
              <el-form ref="form" :model="changeform" label-width="150px" label-position="left" style="margin-left:20px;">
                <el-form-item label="劳保名称" >
                      ...
                      <el-form-item label="部门" >
                        <el-select v-model="changeform.dept_id" clearable style="width: 400px;" placeholder="请选择">
                            <el-option
                              v-for="item in bumenList"
                              :key="item.dept_id"
                              :label="item.dept_name"
  ...
  export default {
      ...
      methods: {
          ...
          updataClick(data){
            ...
            this.changeform.dept_id = data.dept_id;
          ...
          addUserClick(){
                ...
                params.append('laobao_type','bumen');
