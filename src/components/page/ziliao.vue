  ...
  export default {
    ...
    methods: {
        ...
        self.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          type: 'warning'
           ...
           var code = localStorage.getItem('ms_username');
                ...
                var aaa = "[{'fcode':'b01','usercode':'"+code+"','unitlx':'资料','unitcode':'"+row.unitcode+"','unitname':'"+row.unitname+"','unitdesc':'"+row.unitdesc+"','saveflag':'del'}]"
      ...
      request(){
                ...
                var aaa = "[{'fcode':'s01','usercode':'"+code+"','unitlx':'资料'}]"
                var bbb = md5.hex(aaa+'urty');
                self.$axios({
                    method: 'post',
                    url: 'http://www.kofanchina.com/main.php/Home/Request/post2',
