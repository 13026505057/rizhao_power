    ...
    <div>
        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
          <div class="numData">
            ...
            <div class="tableTitle">
              <el-button type="primary" v-if="level=='national'?false:true" @click="showAddNew">新增一体机</el-button>
            </div>
          </div>
            <el-dialog title="新增一体机" :visible.sync="dialogFormVisible">
              <el-form :model="form">
            ...
            <el-dialog title="修改一体机" :visible.sync="dialogFormVisible2">
              <el-form :model="form">
                <el-form-item label="一体机名称:" label-width="120px">
                  <el-input v-model="form.imac_name" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
                <el-form-item label="选择位置:" label-width="120px">
                  <el-button type="primary"  @click="mapClick">点击选择</el-button>
                </el-form-item>
            ...
            <el-dialog title="地图选点组件" :visible.sync="mapVisible" top="5vh">
              <iframe id="mapPage" width="100%" height="700px" frameborder=0
                  src="https://apis.map.qq.com/tools/locpicker?search=1&type=1&key=7NLBZ-VMS6F-I7OJ6-JC2DF-VKD43-IABKA&referer=特殊人员管控">
              </iframe>
              <div slot="footer" class="dialog-footer">
          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                v-if="level=='national'?true:false"
                label="终端激活码"
                align="center"
                prop="imac_code">
              </el-table-column>
              ...
              <el-table-column
                ...
                <template slot-scope="props">
                  <span :class="[props.row.online==0?'colorRed':'']">{{props.row.online==0?'不在线':'在线'}}</span>
                </template>
              </el-table-column>
              <el-table-column
                label="最后在线时间"
              ...
              <el-table-column
                v-if="level=='national'?false:true"
                align="center"
                label="操作">
                <template slot-scope="props">
                  <el-button
