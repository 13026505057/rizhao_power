...
<!--         <div >
        ...
        <div id="container" style="width: 77%;height: 110%;  float: right;">
          <div class="numData">
            ...
            <div class="tableTitle">
              <el-button type="primary" @click="showAddNew">新增机构</el-button>
            </div>
            <el-dialog title="新增机构" :visible.sync="dialogFormVisible">
              <el-form :model="form">
                <el-form-item label="机构名称:" label-width="120px">
                  <el-input v-model="form.org_name" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
              </el-form>
