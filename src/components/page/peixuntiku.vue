<template>
    <div>
        ...
        <div >
            ...
            <div class="block">
               ...
               <el-autocomplete
                ...
                <el-button type="primary" style="margin-left: 100px;" @click="addNew">新增题库</el-button>
            </div>
        ...
        <!-- 新增题库 -->
        <el-dialog title="新增题库" :visible.sync="dialogFormVisible">
          <el-form ref="form" :model="form" label-width="120px" label-position="left" style="margin-left:20px;">
            <el-form-item label="题库名称*" style="display: inline-block;">
              <el-input v-model="form.bank_name" style="width: 400px;float: left;"></el-input>
            </el-form-item>
        ...
        <el-dialog title="添加题库" :visible.sync="addQuestionBox">
          <el-upload
            class="upload-demo"
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="addQuestionBox = false">取 消</el-button>
            <el-button type="primary" @click="sureToAddNew">确定新增</el-button>
          </div>
        </el-dialog>
          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                label="创建人"
                align="center"
                prop="bank_create_user">
              </el-table-column>
              <el-table-column
                label="创建时间"
                align="center"
                prop="bank_create_time">
              </el-table-column>
              <el-table-column
                label="题目数量"
                align="center"
                prop="question_quantity">
              </el-table-column>
              <el-table-column
                label="操作"
                align="center"
                ...
                <template slot-scope="props">
                  <el-button  type="warning" size="mini" @click="addQuestion(props.row)">添加题目</el-button>
                </template> 
              </el-table-column>
            </el-table> 
...
<script>
  ...
  export default {
      ...
      mounted() {
          ...
          var uploadUrl = this.$axios.defaults.baseURL+'/stop/exam/addExamBankQeustionByExcel';
      ...
      methods: {
          ...
          //添加题目
          addQuestion(row){
            this.addQuestionBox=true;
            this.bankId.bank_id = row.bank_id;
          },
          changeData(row){
            console.log(row);
          ...
          getDataList(){
                ...
                params.append('bank_name',this.name);  
                self.$axios({
                    method: 'post',
                    url: '/stop/exam/getExamBanksByPage',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
                    if(data.data.code==0){
