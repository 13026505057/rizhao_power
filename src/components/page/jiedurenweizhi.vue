    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-button type="warning" style="margin-left: 15px;" @click="fenzuSearch">查询</el-button>
            ...
            <el-table
              ...
              <!-- <el-table-column
                ...
                <template slot-scope="props">
                  <span >{{props.row.sign_status==0?'未签到':'已签到'}}</span>
                </template>
              </el-table-column> -->
              <el-table-column
                label="最后出现位置"
              ...
              <!-- <el-table-column
                ...
                >
                <template slot-scope="props">
                  <el-button type="warning" size="mini" @click="lookSave(props.row)">查看</el-button>
                </template>
              </el-table-column> -->
              <el-table-column
                label="最后位置"
                ...
                >
                <template slot-scope="props">
                  <el-button type="warning" size="mini" @click="lookLocation(props.row)">最后位置</el-button>
                </template>
              </el-table-column>
            </el-table> 
  ...
  export default {
      ...
      methods: {
          ...
          getDataList(){
                ...
                self.$axios({
                    method: 'post',
                    url: '/stop/sign/getUsersLastSignsByPage',
                    data: params,
