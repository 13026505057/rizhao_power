...
<!--         <div >
        ...
        <div id="container" style="width: 100%;height: 110%;  float: right;">
          <div class="numData">
            ...
            <div class="tableTitle">
              <el-button type="primary" @click="showAddNew">新增仓库</el-button>
            </div>
          </div>
            <el-dialog title="新增仓库" :visible.sync="dialogFormVisible">
              <el-form :model="form">
                <el-form-item label="仓库名称:" label-width="120px">
                  <el-input v-model="form.store_name" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
                <el-form-item label="仓库位置:" label-width="120px">
                  <el-input v-model="form.store_location" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
                <el-form-item label="仓库面积:" label-width="120px">
                  <el-input v-model="form.store_area" autocomplete="off" style="width:400px;"></el-input>
                </el-form-item>
                <el-form-item label="库管员:" label-width="120px">
                  <el-select v-model="form.kgy_user_id" filterable placeholder="请选择">
                    <el-option
                ...
                <el-form-item label="归属部门:" label-width="120px">
                  <el-select v-model="form.dept_id" filterable placeholder="请选择">
                    <el-option
          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                label="创建者"
                align="center"
                prop="store_create_user_name">
              </el-table-column>
              <el-table-column
                label="创建时间"
                align="center"
                prop="store_create_time">
              </el-table-column>
              <el-table-column
                label="仓库位置"
                align="center"
      ...
      methods: {
          getUserList(){
                ...
                self.$axios({
                    ...
                    if(data.data.code==0){
                      self.userList = data.data.data.list;
          ...
          upData(data){
                ...
                var params = new URLSearchParams();
                var token = localStorage.getItem('auth');
                params.append('store_status',self.form.store_status);    
                params.append('store_id',self.form.store_id);
                params.append('store_name',self.form.store_name);
                params.append('store_location',self.form.store_location);
                params.append('store_area',self.form.store_area); 
                params.append('dept_id',self.form.dept_id);
                params.append('kgy_user_id',self.form.kgy_user_id);
                self.$axios({
                    method: 'post',
          ...
          handleupDate(data){
            ...
            this.form = data
            // this.form.kgy_user_id = data.kgy_user_id
          },
