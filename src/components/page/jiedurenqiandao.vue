    ...
    <div>
        ...
        <div >
            ...
            <div class="block">
                ...
                <el-button type="warning" style="margin-left: 10px;" @click="fenzuSearch">查询</el-button>
               ...
               <el-autocomplete
                  ...
                  @select="handleSelect"
                ></el-autocomplete>
                <el-button type="warning" style="margin-left: 10px;" @click="nameSearch">查询</el-button>
                <el-input
                    clearable
                    placeholder="身份证号查询"
                ...
                <el-select v-model="upload_status" placeholder="是否签到" clearable>
                  <el-option
          ...
          <div class="tableList">
            <el-table
              ...
              <el-table-column
                ...
                width='160'
                prop="upload_status"
                :filters="[{text: '未签到', value: '0'}, {text: '已签到', value: '1'}]"
                :filter-method="filterHandler">
                <template slot-scope="props">
                  <span v-bind:class="[props.row.upload_status==1?'upload':'notUpload']">{{props.row.upload_status==0?'未签到':''}}{{props.row.upload_status==1?'已签到':''}}{{props.row.upload_status==2?'认证失败':''}}</span>
                </template>
              </el-table-column>
              <el-table-column
                label="签到位置"
              ...
              <el-table-column
                ...
                align="center">
                <template slot-scope="props">
                  <el-button v-if="props.row.upload_status==0?false:true" type="warning" size="mini" @click="lookSave(props.row)">查看</el-button>
                </template>
              </el-table-column>
              <el-table-column
                label="地图查看"
                align="center">
                <template slot-scope="props">
                  <el-button v-if="props.row.upload_status==0?false:true" type="warning" size="mini" @click="lookLocation(props.row)">查看</el-button>
                </template>
              </el-table-column>
            </el-table> 
...
<script>
  ...
  export default {
      ...
      methods: {
          lookLocation(data){
            this.locationTitle = data.user_true_name+'最后出现位置'+data.upload_time;
          ...
          drawLocationMap(data){
                ...
                TMap('7NLBZ-VMS6F-I7OJ6-JC2DF-VKD43-IABKA').then(qq => {
                                    ...
                                    latlngsname.push(data.user_true_name);
          ...
          getDataList(){
                ...
                params.append('upload_status',self.upload_status);
                params.append('user_id','');      
                self.$axios({
                    method: 'post',
                    url: '/stop/sign/getUserSignsByPage',
                    data: params,
