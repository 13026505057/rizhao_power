        ...
        <div >
            ...
            <div class="block">
              ...
              <el-select 
                ...
                <el-button type="primary" style="margin-left: 60px;" @click="addUser = true">新增</el-button>
            ...
            >
                  <el-form ref="form" :model="form" label-width="120px" label-position="left" style="margin-left:20px;">
                      ...
                      <el-form-item label="劳保类型" >
                        <el-select v-model="form.laobao_type" clearable style="width: 300px;" placeholder="请选择">
                            <el-option
                              v-for="item in laobaoTypeList"
                              :key="item.value"
                              :label="item.label"
                      ...
                      <!-- <el-form-item label="周期" style="">
                          <el-input v-model="form.zhouqi" style="width: 300px;">
  ...
  export default {
      ...
      methods: {
          ...
          addUserClick(){
                ...
                params.append('laobao_name',self.form.laobao_name);
                params.append('zhouqi',self.form.zhouqi);
                params.append('laobao_type',self.form.laobao_type);
                
                self.$axios({
                    method: 'post',
                    url: '/store/laobao/add',
                    data: params,
                    headers: {'Content-Type': 'application/x-www-form-urlencoded','kf-token':token},
                 }).then(function(data){
                    if(data.data.code==0){
